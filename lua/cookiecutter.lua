...
--    loadstring(game:HttpGet("https://raw.githubusercontent.com/YOU/REPO/main/cookiecutter.lua"))()
--
--  How it works:
...
local CONFIG = {
    ...
    -- ============================
    dll_url = "https://raw.githubusercontent.com/YOU/CookieCutter/main/cookiecutter.dll",
